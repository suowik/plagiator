...
public class DefaultRunner implements Runner {
    ...
    private ComparisonResult compare(Document document, StoredDocument next) throws FileNotFoundException {
        ...
        DefaultComparisonResult defaultComparisonResult = new DefaultComparisonResult(status, document.getFile().getName(), next.getFileName(), date, analyze);
        resultDao.save(defaultComparisonResult);
